...
int
LBA_engine::initCostume (byte arg_0, short int actorNumber)
{
  actor *act;
  char type;
//      int temp;
...
void
LBA_engine::loadActorCostume (char arg_0, short int arg_4)
{
  actor *lactor;
  int temp;
  int temp2;
...
// short int var5, var6;
  ...
  if (temp != -1)
	...
	return;
      ...
      loadActorCostumeSub (bodyPtrTab[currentIndex],
...
void
LBA_engine::loadActorCostumeSub (unsigned char *arg_0, unsigned char *arg_4)
{
