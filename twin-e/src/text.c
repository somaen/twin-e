...
void LBA_engine::loadTextBank(int index)   // ca devrais plutot etre un truc du genre loadTextBank
{
...
{
	drawBoxTrans(dialogueBoxLeft,dialogueBoxTop,dialogueBoxRight,dialogueBoxBottom,(char*)videoBuffer2,dialogueBoxLeft,dialogueBoxTop,(char*)videoBuffer1);
	if(newGameVar4!=0)
	{
	...
	osystem->refresh(videoBuffer1,dialogueBoxLeft,dialogueBoxTop,dialogueBoxRight,dialogueBoxBottom);

	printText8Var3=0;
	
	drawBoxTrans(dialogueBoxLeft,dialogueBoxTop,dialogueBoxRight,dialogueBoxBottom,(char*)videoBuffer1,dialogueBoxLeft,dialogueBoxTop,(char*)videoBuffer2);
}
...
void LBA_engine::printText10Sub(void)
{
 ...
 numOfVertex=3; 
	...
	osystem->refresh(videoBuffer1,dialogueBoxRight-24, dialogueBoxBottom-24, dialogueBoxRight-3, dialogueBoxBottom-3);
