...
//	char param;
	...
	{
		drawBoxTrans(left,top,right,bottom,(char*)videoBuffer2,left,top,(char*)videoBuffer1);
		right2=right;
...
void LBA_engine::drawBoxTrans(int left, int top,int right, int bottom, char* source, int leftDest, int topDest, char* dest)  // pout les boutons actifs
{
